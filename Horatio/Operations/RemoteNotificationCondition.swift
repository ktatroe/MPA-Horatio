...
/**
    A bridge to give access to Objective-C classes access to the RemoteNotificationCondition
    methods necessary to configure it.
*/
@objc class RemoteNotificationConditionBridge: NSObject {
    static func didReceiveNotificationToken(_ token: Data) {
